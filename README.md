...
![Arogya Dashboard](https://raw.githubusercontent.com/Karthik-bhandarkar/agent-Frontend/main/public/dashboard-preview.png)
*(To update this screenshot, replace `public/dashboard-preview.png` in the repository)*
